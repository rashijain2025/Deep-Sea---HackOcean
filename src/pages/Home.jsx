...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full overflow-y-auto overflow-x-hidden relative text-slate-50 selection:bg-cyan-500/30 font-sans pb-24" style={{ WebkitOverflowScrolling: 'touch', transform: 'translateZ(0)' }}>
      ...
      {/* ─── 1. HERO SECTION ─── */}
      <section className="relative min-h-[100svh] flex flex-col items-center justify-between pt-24 pb-8 md:pb-12 overflow-hidden">
        ...
        <motion.div 
          className="relative z-10 text-center max-w-5xl px-6 flex-1 flex flex-col items-center justify-center py-12"
          initial="hidden"
          animate="visible"
        ...
        <motion.div 
          className="relative w-full max-w-6xl px-6 z-20 mt-auto shrink-0"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.8, ease: [0.16, 1, 0.3, 1] }}
        >
          <div className="premium-glass p-6 rounded-2xl grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 lg:divide-x lg:divide-slate-800/50">
